...
const multiSelectVariants = cva("transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
      default: "border border-border hover:border-ring hover:bg-background ",
      outline: "border border-border hover:border-primary hover:bg-background " ,
      filled:"border border-transparent bg-secondary hover:bg-secondary/80",
    },
  },
  defaultVariants: {
    variant: "default",
...
const badgeSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
  variants: {
    badgeAnimation: {
...
interface MultiSelectProps
  ...
  variantBadge?:VariantProps<typeof badgeSelectVariants>["badgeAnimation"];
  ...
  (
    ...
    const isGroupedOptions = React.useCallback(
      (
        ...
        return Array.isArray(opts) && opts.length > 0 && !!opts[0] && "heading" in opts[0];
      },
      []
    );
        ...
        >
          ...
          <div id={selectedCountId} className="sr-only" aria-live="polite">
            {selectedValues.length === 0
              ...
              : `${selectedValues.length} opcion${
                  selectedValues.length === 1 ? "" : "es"
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md bg-background hover:bg-muted text-foreground min-h-9 h-auto items-center justify-between [&_svg]:pointer-events-auto",
                ...
                <div className="flex justify-between items-center w-full">
                        ...
                        return (
                          <Badge
                            ...
                            className={cn(
                              ...
                              badgeSelectVariants({ badgeAnimation: variantBadge }),
                              customStyle?.gradient &&
                              ...
                              "[&>svg]:pointer-events-auto items-center"
                            )}
                            style={{
                              ...badgeStyle,
                              animationDuration: `${
                          ...
                          >
                            ...
                            <div
                              ...
                              className="ml-2 h-4 flex flex-col justify-center cursor-pointer rounded-sm  focus:outline-none "
                            >
                              <Icon
                                name="close"
                                className="text-xs"
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="flex items-center justify-center h-4 w-4 mx-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-sm"
                    >
                      <Icon name="close" />
                    </div>
                    <Separator
          ...
          <PopoverContent
            ...
            className={cn(
              "w-auto px-5 py-4 border border-border bg-popover text-popover-foreground",
          ...
          >
            <Command>
			  ...
			  {searchable && <span className="mb-4 w-full"></span>}
              <CommandList
                className={cn(
                ...
                {!hideSelectAll && !searchValue && (
                  <CommandGroup className="p-0">
                    ...
                    >
                      <div
                        className={cn(
                          "mr-2 flex h-5 w-5 items-center justify-center rounded-[2px] border border-primary",
                          selectedValues.length ===
